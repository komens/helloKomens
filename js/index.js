config = {
    ...
    getOneSay: function() {
        ...
        let type = 'POST';
        let data={"TransCode":"030111","OpenId":"123456789","Body":""};
        this.ajax(url,type,data,(res)=>{
            let data = res.Body;
            self.oneImg.style.backgroundImage = `url('${data.img_url}')`;
            self.oneSay.innerText = data.word;
